...
import com.mixky.wechathelp.view.AutoFloatView;
import com.mixky.wechathelp.view.ManualFloatView;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    protected void onDestroy() {
        super.onDestroy();
        OSUtil.getInstance().closeAndDestroy();
    }
